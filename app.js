...
      let pointsHeader = `<div style="display:flex; justify-content:space-between; align-items:center; gap:6px; margin-bottom:2px;">
...
          </div>
      </div><div style="border-bottom:1px solid rgba(150,150,150,0.1); margin:0 -12px 2px -12px;"></div>`;
      
