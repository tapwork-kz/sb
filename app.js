...
  }
      ...
      listHtml += "</div>"; 
          ...
          document.getElementById("details-title").innerHTML = `<span class="material-symbols-rounded" style="font-size:20px; display:inline-flex; align-items:center; justify-content:center; vertical-align:middle; margin-right:6px; color:#3390ec; line-height:1;">assignment</span>Мои отчеты`; 
